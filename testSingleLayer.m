function [ error, loss ] = testSingleLayer(testData,testLabels,numOutputs,weights,biases,NLFunc,lossFunc)
...
for p=1:size(testData,1)
    predictedLabels(p,:) = singleLayerPredict(testData(p,:),weights,biases,NLFunc);
